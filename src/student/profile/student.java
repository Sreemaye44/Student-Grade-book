...
public class student extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        sign.setBackground(new java.awt.Color(150, 55, 38));

        jButton2.setBackground(new java.awt.Color(106, 34, 34));
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/student/profile/sign.jpg"))); // NOI18N
        ...
        wrr.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        wrr.setForeground(new java.awt.Color(255, 51, 51));
        ...
        Sprofile.add(up1);
        up1.setBounds(364, 125, 73, 23);

        wg1.setBackground(new java.awt.Color(204, 0, 0));
        Sprofile.add(wg1);
        wg1.setBounds(848, 513, 193, 28);

        re1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        re1.setText("Reset");
        ...
        wg.setForeground(new java.awt.Color(51, 51, 51));
        wg.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        Sprofile.add(wg);
        wg.setBounds(143, 595, 272, 29);

        jLabel15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/student/profile/profile.jpg"))); // NOI18N
        jLabel15.setText("jLabel15");
        Sprofile.add(jLabel15);
        jLabel15.setBounds(-90, 0, 1440, 690);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
     ...
     if(u.equals("ruet") && p.equals("cse") && level.getSelectedItem()=="Admin")
     {
       parent.removeAll();
       parent.add(Sprofile);
       parent.repaint();
     ...
     else if(u.equals("student") && p.equals("1111") && level.getSelectedItem()=="Student")
     {
       parent.removeAll();
       parent.add(Sprofile);
       parent.repaint();
    ...
    private void add1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add1ActionPerformed
        ...
        g1=Double.parseDouble(gr1.getText().toString());
         ...
         DecimalFormat df = new DecimalFormat("#.##");
        df.format(ct);
         String p=df.format(ct);//values for grade


        if(!name1.getText().trim().equals(""))
        {
            model1.addRow(new Object[]{name1.getText(),roll1.getText(),reg1.getText(),sesson1.getText(),p});
        }
        else
        {
